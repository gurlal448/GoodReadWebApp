...
namespace GoodReadWebApp.Controllers
{
    ...
    public class PublicationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PublicationID,PublicationName")] Publication publication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PublicationID,PublicationName")] Publication publication)
        {
